...
//SQL Query
	private static final String GET_EMPS_QUERY ="SELECT EMPNO, ENAME, DESG, SALARY, DEPTNO FROM EMPLOYEE WHERE DESG IN (?, ?, ?)";
	private static final String INSERT_EMP_QUERY = "INSERT INTO Employee (EMPNO, ENAME, DESG, SALARY, DEPTNO)VALUES (EMP_SEQ.NEXTVAL,?, ?, ?, ?)";
	...
	public List<Employee> showEmployeeByDesg(String desg1, String desg2, String desg3) throws Exception {
	  ...
	  catch (SQLException se) { se.printStackTrace(); throw se;
	  
	  } catch (Exception e) { e.printStackTrace(); throw e; } return list; }
